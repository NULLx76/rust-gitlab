...
The API is based off of the GitLab 17.4 API v4 and will likely aggressively track
...
possible. Instead, the crate uses the following versioning scheme:
  ...
  * Gitlab 17.4 support → 0.1704.x
  * Gitlab 17.3 support → 0.1703.x
  * Gitlab 17.2 support → 0.1702.x
